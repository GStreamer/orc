...
void orc_c64x_loadq (OrcCompiler *compiler, int dest, int src1, int update, int is_aligned);
...
void orc_c64x_storeq (OrcCompiler *compiler, int dest, int update, int src1, int is_aligned);
