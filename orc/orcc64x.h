...
#define C64X_A0 (ORC_GP_REG_BASE+0)
#define C64X_A1 (ORC_GP_REG_BASE+1)
#define C64X_A2 (ORC_GP_REG_BASE+2)
#define C64X_A3 (ORC_GP_REG_BASE+3)
#define C64X_B0 (ORC_GP_REG_BASE+4)
#define C64X_B1 (ORC_GP_REG_BASE+5)
#define C64X_B2 (ORC_GP_REG_BASE+6)
#define C64X_B3 (ORC_GP_REG_BASE+7)
#define C64X_A4 (ORC_GP_REG_BASE+8)
#define C64X_A5 (ORC_GP_REG_BASE+9)
